...
import { getEventBySlug, getEventById, getPriceHistory, getOrderBook, searchEvents } from './lib/polymarket';
import { getUcdbMarkets, getUcdbMarketById } from './lib/ucdb-markets';
import { fetchWorldCup2026Events } from './lib/world-cup';
...
async function startServer() {
  ...
  app.listen(PORT, '0.0.0.0', () => {
    console.log(`Arena Polymarket em http://localhost:${PORT}`);
  });
}
